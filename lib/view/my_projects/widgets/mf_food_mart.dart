...
class MfFoodMart extends StatelessWidget {
  ...
  final bool isPhone;
  const MfFoodMart({super.key, required this.constraints, this.isPhone=true,});
      ...
      return InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: value.isHover? Colors.grey.withOpacity(0.1):Colors.transparent,
          ...
          child:constraints.maxWidth<700?Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text("MF Food Mart (Android & iOS)",style: AppTextStyle.normalStyle(fontSize:constraints.maxWidth<600? 15:20,fontWeight: FontWeight.bold),),
                  const SizedBox(height: 10,),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ProjectTitle(
                            ...
                            title: "This is an online grocery app for Canada."),
                        ProjectTitle(
                            fontSize:constraints.maxWidth<600 ?13:16,
                            title: "Users can buy their favorite grocery products through this app."),
                        ProjectTitle(
                            fontSize:constraints.maxWidth<600 ?13:16,
                            title: "Payment gateway integration."),
                        ProjectTitle(
                            fontSize:constraints.maxWidth<600 ?13:16,
                            title: "User can make cash on delivery or card payment."),
                      ],
                    ),
                  ),
